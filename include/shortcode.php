...
if (!function_exists('nr_dowooma_get_product_ids_from_shortcode')) {
    function nr_dowooma_get_product_ids_from_shortcode($product_ids) {
...
$unique_id = uniqid();
$product_ids = nr_dowooma_get_product_ids_from_shortcode($_GET['product_ids']);
?>

<form id="nr_dowooma_form_<?php echo $unique_id; ?>">
    <?php
...
if (!empty($option) && is_array($option)) {
                ...
                ?>
                       ...
                       <?php echo $p_title; ?>
                                ...
                                <div class="dowooma_loop_pquantity">
                                    <span class="dowooma_pprice_middle" id="dowooma_loop_pquantity_<?php echo $i . "_" . $pid; ?>">0</span>
                                    <div class="counter_lr">

                                        <span class="dowooma_pprice_right" onclick="nr_dowooma_loop_pright_fn(<?php echo $i . "," . $pid; ?>)"><i class="fa fa-plus"></i></span>
                                        <span class="dowooma_pprice_left" onclick="nr_dowooma_loop_pleft_fn(<?php echo $i . "," . $pid; ?>)"><i class="fa fa-minus"></i></span>
    ...
    ?>
        ...
        <div class="bottom_bar_cart">
            <input type="hidden" id="nr_dowooma_total_amount" value="0">
            <input type="submit" name="submit" id="nr_dowooma_form_submit" value="SPENDEN">
